...
#model.fit(images, labels, n_epoch=90, shuffle=True, show_metric=True, validation_set=0.1)
#model.save('rgb_faces.tflearn')

np.set_printoptions(3, suppress=True)

detect("CanerVideo/WIN_20180727_13_43_17_Pro.mp4", model)
