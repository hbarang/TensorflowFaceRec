...
dataset = "newdata_test.txt"

images, labels = image_preloader(dataset, image_shape=(128, 128), mode='file', categorical_labels=True, normalize=True)
...
network = input_data(shape=[None, 128, 128, 1], data_preprocessing=preProc)
...
model.load('./playground.tflearn')
#model.fit(images, labels, n_epoch=15, shuffle=True, show_metric=True, validation_set=0.1)
#model.save('playground.tflearn')

np.set_printoptions(3, suppress=True)


test_image = Image.open("test644.jpg")
